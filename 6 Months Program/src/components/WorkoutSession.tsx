...
const WORKOUT_PLANS: WorkoutPlan[] = [
  ...
  },
  {
    ...
    exercises: [
      ...
      { name: 'Dead Hang (if bar available)', duration: 30, icon: '🙆', sprite: { row: 2, col: 0, frames: 4 } },
      { name: 'Reverse Snow Angels', duration: 0, reps: '3 × 12', icon: '👼', sprite: { row: 3, col: 0, frames: 4 } },
  ...
  },
  {
    ...
    exercises: [
      { name: 'Warm-up High Knees', duration: 60, icon: '🦵', sprite: { row: 0, col: 0, frames: 4 } },
      { name: 'Bodyweight Squats', duration: 0, reps: '3 × 20', icon: '🏋️', videoUrl: '/animations/squats.mp4' },
      { name: 'Bulgarian Split Squats', duration: 0, reps: '3 × 12 each', icon: '🔀', videoUrl: '/animations/bulgarian_split_squats.mp4' },
      { name: 'Glute Bridges', duration: 0, reps: '3 × 15', icon: '🌉', sprite: { row: 5, col: 0, frames: 4 } },
      { name: 'Wall Sit', duration: 45, icon: '🧱', sprite: { row: 0, col: 1, frames: 4 } },
  ...
  },
  {
    ...
    exercises: [
      ...
      { name: 'Push-ups', duration: 0, reps: '3 × 15', icon: '💪', videoUrl: '/animations/push_ups.mp4' },
      { name: 'Plank to Down Dog', duration: 45, icon: '🐕', sprite: { row: 2, col: 1, frames: 4 } },
  ...
  },
  {
    ...
    exercises: [
      ...
      { name: 'Plank Hold', duration: 60, icon: '🧱', videoUrl: '/animations/plank.mp4' },
      { name: 'Russian Twists', duration: 0, reps: '3 × 20', icon: '🔄', sprite: { row: 1, col: 0, frames: 4 } },
      { name: 'High Knees Sprint', duration: 45, icon: '🏃', videoUrl: '/animations/High_knee_sprint_202605091325.mp4' },
      { name: 'Leg Raises', duration: 0, reps: '3 × 12', icon: '🦵', sprite: { row: 3, col: 1, frames: 4 } },
      { name: 'Burpees', duration: 0, reps: '3 × 8', icon: '🔥', videoUrl: '/animations/Professional_burpees_202605091344.mp4' },
      { name: 'Side Plank (Each Side)', duration: 30, icon: '📐', sprite: { row: 4, col: 1, frames: 4 } },
      { name: 'Cool-down Stretch', duration: 90, icon: '🧘' },
    ],
  },
];
